...
export default function Footer() {
    return (
        <footer className="footer-root relative w-full px-5 sm:px-8 md:px-10 lg:px-20 pt-6 sm:pt-16 pb-4 sm:pb-6 flex flex-col bg-gradient-secondary text-white overflow-hidden">
            {/* Upper content */}
