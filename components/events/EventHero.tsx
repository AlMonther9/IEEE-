...
const EventHero = () => {
  ...
  return (
    <div className="-mt-24 min-h-screen pb-20 bg-gradient-main text-white">
      <div className="mx-auto w-full">
        <section className="relative overflow-hidden border border-primary-blue/30 bg-black/20">
          ...
          <div className="relative z-10 min-h-95 px-5 pb-14 pt-6 sm:px-8 lg:px-28">
            <div className="flex items-center justify-between pt-2">
              <button
                type="button"
                onClick={() => router.back()}
                className="inline-flex cursor-pointer items-center gap-2 rounded-full border border-white/40 bg-white/10 px-3 py-1.5 text-xs font-medium text-white/90 backdrop-blur-sm transition hover:bg-white/20"
              >
              ...
              <button
                type="button"
                className="inline-flex cursor-pointer items-center justify-center rounded-full border border-white/20 bg-white/10 p-2 text-white/90 backdrop-blur-sm transition hover:bg-white/20"
              >
            ...
            <div className="mt-20 max-w-2xl">
              <p className="inline-flex mb-6 rounded-full bg-primary-blue px-4 py-2 font-semibold text-xs tracking-wide text-white">
                Workshop
              </p>
        ...
        <div className="relative z-20 px-24 -mt-10 grid gap-8 lg:grid-cols-[1.4fr_0.8fr] lg:gap-10">
          <div className="space-y-8">
            ...
            <article className="rounded-2xl border border-primary-blue/30 bg-white/5 p-6 backdrop-blur-md sm:p-7">
              ...
              <p className="mt-3 text-sm leading-relaxed text-white/75 max-w-2xl sm:text-base">
                ...
                {scheduleData.map((item, index) => (
                  ...
                  >
                    {index !== scheduleData.length - 1 && (
                      <span
                        className={`absolute left-5 top-8 h-[calc(100%)] w-px transition ${item.isActive
                    ...
                    <div className="flex items-start gap-4 pl-10 pb-4">
                      <span
                        className={`absolute left-2 top-1 inline-flex h-6 w-6 items-center justify-center rounded-full border transition ${item.isActive
                      ...
                      >
                        <span
                          className={`h-2 w-2 rounded-full transition ${item.isActive
                            ? 'bg-primary-yellow'
                      ...
                      <div className="flex-1">
                        <p
                          className={`inline-flex items-center gap-1.5 text-xs font-semibold tracking-wide transition ${item.isActive
                            ? 'text-primary-yellow'
          ...
          {/* // Sidebar //  */}
          <aside className="h-fit sticky top-20 rounded-2xl border border-primary-blue/20 bg-gradient-secondary/85 p-6 backdrop-blur-md lg:mt-16">
